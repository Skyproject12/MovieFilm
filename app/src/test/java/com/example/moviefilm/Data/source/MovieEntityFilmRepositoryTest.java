...
public class MovieEntityFilmRepositoryTest {
    ...
    public void getAllMovie(){
        ...
        List<MovieEntity> result= LiveDataTestUtils.getValue(movieFilmRepository.getMovieAll());
    ...
    public void getMovieId(){
        ...
        List<MovieEntity> result= LiveDataTestUtils.getValue(movieFilmRepository.getMovieId(movieId));
