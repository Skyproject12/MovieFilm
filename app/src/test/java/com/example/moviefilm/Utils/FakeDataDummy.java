...
public class FakeDataDummy {
    ...
    public static List<MovieEntity> generateMovieWithFavorite(MovieEntity movieEntity, boolean favorite){
        List<MovieEntity> movie= new ArrayList<>();
        movie= generateMovie();
//        MovieEntity movieList = null;
//        for (int i = 0; i <movie.size() ; i++) {
//             movieList= new MovieEntity(
//                    movie.get(i).getId(),
//                    movie.get(i).getImage(),
//                    movie.get(i).getJudul(),
//                    movie.get(i).getDeskripsi(),
//                    movie.get(i).getTanggalRilis(),
//                    movie.get(i).isFavorite()
//            );
//        }
        return movie;
    }

    public static List<TvshowEntity> generateTvshowWithFavorite(TvshowEntity tvshowEntity, boolean favorite){
        List<TvshowEntity> tvshow= new ArrayList<>();
        tvshow= generateShow();
        return tvshow;
    }
